...
function CustomSelect({
    ...
    return (
        <div className="relative" ref={ref}>
            <button
                type="button"
                className={`h-[56px] w-full rounded-lg bg-slate-50 border border-transparent px-4 text-left text-[15px] font-semibold transition-colors flex items-center justify-between shadow-sm
            ...
            {isOpen && !disabled && (
                <div className="absolute z-50 w-full mt-2 rounded-xl bg-white shadow-2xl shadow-slate-200/50 border border-slate-100/80 overflow-hidden flex flex-col max-h-[320px] ring-1 ring-slate-900/5">
                    {/* Search Input */}
    ...
    return (
        <section ref={sectionRef} className={`py-12 bg-slate-50 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="container-width px-6">
                <div className="rounded-xl bg-white border border-slate-200/60 shadow-md p-8 md:p-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-4 items-end">
                        <div className="space-y-1.5 sm:col-span-2 lg:col-span-2">
                            ...
                            <div className="h-[56px] w-full rounded-lg bg-slate-50 border border-transparent px-5 flex items-center shadow-sm hover:bg-slate-100 transition-colors">
                                <Slider
                        ...
                        <div className="sm:col-span-1 lg:col-span-2">
                            <Button onClick={handleSubmit} className="h-[56px] w-full rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg shadow-lg shadow-blue-600/20 border border-blue-500 transition-all active:scale-[0.98]">
