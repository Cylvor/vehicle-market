    ...
    return (
        <section className="py-14 bg-background">
            <div className="container-width">
                <div className="rounded-3xl border border-border/70 bg-card/70 p-6 md:p-8 backdrop-blur-sm">
                    ...
                    <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
                        {PRICE_SHORTCUTS.map((shortcut) => (
                            <Link
                                key={shortcut.label}
                                href={shortcut.href}
                                className="rounded-2xl border border-accent/30 bg-accent/10 px-5 py-3 text-sm font-semibold text-accent hover:-translate-y-0.5 hover:bg-accent hover:text-accent-foreground hover:shadow-md transition-all"
                            >
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="relative h-36 overflow-hidden rounded-2xl border border-border/70">
