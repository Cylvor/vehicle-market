                ...
                <div className="relative overflow-hidden rounded-[20px] bg-gradient-to-br from-emerald-600 to-teal-800 p-6 shadow-xl text-white group cursor-pointer hover:shadow-2xl hover:shadow-emerald-500/30 transition-all hover:-translate-y-1">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="pt-4 mt-6 border-t border-white/20 flex items-center justify-between">
                            <span className="text-sm font-bold bg-white text-emerald-700 px-3 py-1 rounded-full shadow-sm flex items-center gap-1">
            ...
            <div className="relative overflow-hidden rounded-[20px] bg-slate-900 dark:bg-black p-8 shadow-xl group border border-slate-800">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="text-white max-w-lg">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-400 text-sm font-bold mb-4 backdrop-blur-md">
                    ...
                    <Link href="/search">
                        <Button className="h-14 px-8 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl shadow-[0_0_20px_rgba(16,185,129,0.4)] hover:shadow-[0_0_30px_rgba(16,185,129,0.6)] transition-all flex items-center gap-2 shrink-0 border-none">
                ...
                <div className="space-y-6">
                    {[1, 2].map((i) => (
                        <div key={i} className="flex items-start gap-4 pb-6 border-b border-slate-100 dark:border-slate-800 last:border-0 last:pb-0">
                            <div className="h-16 w-24 shrink-0 rounded-xl bg-slate-100 dark:bg-slate-800 overflow-hidden relative border border-slate-200 dark:border-slate-700">
                            ...
                            <Button variant="outline" size="sm" className="hidden sm:flex rounded-lg font-bold hover:bg-emerald-50 dark:hover:bg-emerald-900/30 hover:text-emerald-700 dark:hover:text-emerald-400">
                                View Details
                            </Button>
                        </div>
                    ))}
